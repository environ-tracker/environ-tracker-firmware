...
#ifndef ZEPHYR_INCLUDE_DRIVERS_GPIO_GPIO_SX1508B_H_
#define ZEPHYR_INCLUDE_DRIVERS_GPIO_GPIO_SX1508B_H_
 ...
 *
 * Configure a pin to be controlled by SX1508B LED driver using
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_GPIO_GPIO_SX1508B_H_ */
